...
class BillingApp:
    ...
    def setup_ui(self):
        ...
        ttk.Button(frame, text="Print Bill", command=self.generate_pdf_bill).grid(row=10, column=4, columnspan=2,
                                                                                  padx=5, pady=5,
                                                                                  sticky="ew")
        ...
        if particular:
            ...
            if result:
                ...
                messagebox.showwarning("Product Not Found",
                                       f"The product '{particular}' is not available in the database.")
    ...
    def populate_product_details_by_code(self, event):
        ...
        if product_code:
            ...
            if result:
                ...
                messagebox.showwarning("Product Not Found",
                                       f"The product with code '{product_code}' is not available in the database.")
