...
class ProductManager:
    ...
    def setup_ui(self):
        ...
        cashmemo_button = tk.Button(self.tabs_frame, text="Cash Memo", bg="grey", fg="white", cursor="hand2", padx=50,
                                    command=self.cashmemo_caller)
        ...
        ttk.Button(product_frame, text="Delete Product", command=self.delete_product).grid(row=3, column=2, padx=2,
                                                                                           pady=2)
